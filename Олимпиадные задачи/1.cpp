...
int main()
{
	...
	{
		std::cout << "Введенное число не трехзначное, повторите ввод" << std::endl;
		std::cin >> x;
	}
	std::cout << "Все возможные последовательности чисел: " << std::endl;
	x1 = a * 100 + b * 10 + c;
	...
	std::cout << "Наибольшее из этих чисел: " << std::endl;
